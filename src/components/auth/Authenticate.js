        ...
        <div>
          ...
          return (
           <div className="col-md-3" >
            ...
            {context.active ?  (<span>{context.account.substring(0, 6) + "..."+ context.account.substring(38, 42)} <button   onClick={() => {
              deactivate();
            }} className="auto btn btn-success btn-sm  "> Logout <FontAwesomeIcon icon={faPlus} /> </button></span>): (<button onClick={toggle}  className="auto btn btn-success btn-sm  "> Connect <FontAwesomeIcon icon={faPlus} /> </button>
            )}
