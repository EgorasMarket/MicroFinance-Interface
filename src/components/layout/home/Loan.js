...
const {
 ...
 account
  ...
  useEffect(() => {
    ...
    if (typeof loans.data !== "undefined") {
     
        let index = match.params.id;
        let accepted = parseInt(loans.data[index].accepted);
        let declined = parseInt(loans.data[index].declined);
        ...
        console.log(loans.data[index]);
       setLoanData(loans.data[index]);
       setLoanCompany({
        company_description: loans.data[index].companies.company_description,
        company_logo: loans.data[index].companies.company_logo,
        name_of_company: loans.data[index].companies.name_of_company,
        location: loans.data[index].companies.location,
        company_offset_loan: loans.data[index].companies.company_offset_loan,
       });
      setDirectors(loans.data[index].companies.directors);
              ...
              <div className='mb-3'>
                ...
                >
                  <div className='card border-0'>
                    <CardBody>
                    <div dangerouslySetInnerHTML={{__html: loanData.story}} />
                ...
                >
                  <div className='card border-0'>
                    <CardBody>
                      ...
                      <NumberFormat thousandSeparator={true} thousandsGroupStyle="usd" displayType={'text'} prefix={'$'} value={parseFloat(loanData.loan_amount)}/>
