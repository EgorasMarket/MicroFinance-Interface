...
import { faPlus, faSpinner, faCheckCircle, faTimes } from "@fortawesome/free-solid-svg-icons";
    ...
    <div className='mt-6'>
      ...
      />
            ...
            <div className='col-md-12'>
                ...
                <button onClick={e => onAddDirector(e)} className=" btn btn-info btn-sm text-right" disabled={isValid}>{isAddingDirector ? (<FontAwesomeIcon icon={faSpinner} spin />) : null} {btnDirectorText}</button>
...
<button onClick={e => onSubmit(e)} className=" btn btn-success btn-sm text-right" disabled={isFormValid}>{isLoading ? (<FontAwesomeIcon icon={faSpinner} spin />) : null} {btnText}</button>
