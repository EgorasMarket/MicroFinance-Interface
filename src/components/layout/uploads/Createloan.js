...
import { faPlus, faSpinner, faCheckCircle } from "@fortawesome/free-solid-svg-icons";
...
import { loan, messenger  } from "../../../actions/loans";
...
const Createloan = props => {
  ...
  const { loan_category, loan_tile, cover_image, loan_duration, country, loan_fees, loan_payable, story, loan_amount, payment_model } = formData;
...
const submit = async (e) => { 
  ...
  setBtnText("Saving....");
  setIsLoading(true);
  const promise = await props.loan(loan_tile, cover_image, loan_duration, loan_category, country, loan_fees, loan_payable, story, loan_amount, context.account, payment_model);
 
      
      if (promise.status == true) {  
     
     let ret = await creatLoan(parseEther(loan_amount.toString(), "wei").toString(),  loan_tile, loan_duration, promise.cover_image, library.getSigner());
        if(ret.status == true){
          setIsLoading(false);
...
const isStageThreeIsValid = country  !== "0" && loan_fees !== "0" && loan_payable !== "0" && !isLoading;
  return (
    <div className='mt-6'>
    <button className="btn btn-success" onClick={e => test(e)}> Test Units</button>
                      ...
                      <div className='row'>
                        <div className='col-md-7'>
                          ...
                          <FormGroup>
                            ...
                            <Input type='text' name="loan_tile" placeholder='Title...' value={loan_tile} onChange={e => onChange(e)} />
                          </FormGroup>
                          ...
                          <FormGroup>
                            ...
                            <Input type='number' name="loan_amount" placeholder='Enter loan amount...' value={loan_amount} onChange={e => onChange(e)} />
                          </FormGroup>
                          ...
                          <FormGroup>
                            ...
                            <Input type='text' placeholder='Duraton...' id="loan_duration" name="loan_duration" value={loan_duration} onChange={e => onChange(e)} />
                          </FormGroup>
                          <FormGroup>
                            ...
                            {/* <FormText color='muted'>
                             You can choose daily or weekly repayment.
                            </FormText> */}
                      ...
                      <div className='row'>
                        <div className='col-md-12'>
                          <FormGroup>
                            <h2>Story</h2>
                            <p>
                              Tell potential distributors more about your
                              campaign. Provide details that will motivate
                              people to contribute. A good pitch is compelling,
                              informative and easy to digest. Learn more. Images
                              that are intended to span the width of the story
                              section should have a minimum width of 695 pixels.
                              Images wider than 695 pixels will be resized
                              proportionally.
                            </p>
                            <Editor
      ...
      />
                          ...
                          <button className='btn btn-success' disabled={!isStageTwoIsValid} onClick={e => changeStage(e)}>
                            Save & continue
                          </button>
                    ...
                    <Card body className=''>
                      <div className='row'>
                        <div className='col-md-7'>
                          ...
                          <FormGroup>
                            <Label className='mb-0 text-success font-weight-bold'>Country:</Label>

                            <select class='form-control' id="country" name="country" value={country} onChange={e => onChange(e)} >
                              <option value="0">Choose...</option>
                          ...
                          <FormGroup>
                            <Label className='mb-0 text-success font-weight-bold'>
                              Is there any other fees attached to the loan?
                            </Label>
                            {/* <FormText color='muted'>
                              How many days will you be running your campaign
                              for? you can run your campaign for any number of
                            ...
                            <select class='form-control' id="loan_fees" name="loan_fees" value={loan_fees} onChange={e => onChange(e)}>
                              <option value="0">Choose...</option>
                          ...
                          <FormGroup>
                            ...
                            <select class='form-control' id="loan_payable" name="loan_payable" value={loan_payable} onChange={e => onChange(e)}>
                            <option value="0">Choose...</option>
                              <option value="yes">Yes</option>
                              <option value="no">No</option>
                            </select>
